...
function headersFromValues_(name, values) { const headerRow = Array.isArray(values) && Array.isArray(values[0]) ? values[0] : []; const headers = headerRow.map(String); validateHeaders_(name, headers); return headers; }
